...
?>
            ...
            <tr valign="top" style="font-weight:bold;">
        				<td><?php echo __('Task' , 'wpit-gantt') ;  ?></td>
                ...
                <td><?php echo __('Class （important, urgent)' , 'wpit-gantt') ;  ?></td>
								<td><?php echo __('Link' , 'wpit-gantt') ;  ?></td>
        			</tr>
                    </thead>	<tbody>
					<?php
					$index = 0;
			...
			?>
        				...
        				<tr valign="top">
        						...
        						<td><input type="text" name="gantt[<?php echo $index; ?>][class]" value="<?php echo $c ?>" class="large-text code"/></td>
										<td><input type="text" name="gantt[<?php echo $index; ?>][link]" value="<?php echo $link ?>" class="large-text code"/></td>
        				</tr>
        				<?php $index++;
        				} //end foreach
                    ...
                    <tbody>
                        <tr valign="top">
        						...
        						<td><input type="text" name="gantt[<?php echo $index; ?>][class]" value="" class="large-text code"/></td>
										<td><input type="text" name="gantt[<?php echo $index; ?>][link]" value="" class="large-text code"/></td>
								</tr>
        				<tr>
        					<td><hr /></td>
        				</tr>
